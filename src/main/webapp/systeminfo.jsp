...
">
            ...
            <li role="presentation" class="divider"></li>
            <li class="active"><a href="systeminfo.jsp"><span class="glyphicon glyphicon-user"></span>系统信息</a></li>
        </ul>
    ...
    <div class=" col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                <li><a href="systeminfo.jsp"><span class="glyphicon glyphicon-home"></span></a></li>
